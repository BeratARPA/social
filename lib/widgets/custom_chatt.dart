...
class CustomChatt extends StatefulWidget {
  final String chatId;
  ...
  @override
  State<CustomChatt> createState() => _CustomChattState();
}

class _CustomChattState extends State<CustomChatt> {
  ...
  // ======================== MESAJ ITEM VE ICERIGI METODLARI ========================
  ...
  Widget _buildMessageContent(ChatMessage message) {
    switch (message.type) {
      case MessageType.text:
        return _buildTextWithLinks(message.content);
      ...
      case MessageType.video:
        return _buildVideoWidget(message.content);
  ...
  // ======================== MEDIA KONTROL VE DOGRULAMA METODLARI ========================
  ...
  Widget _buildVideoWidget(String videoUrl) {
    return Container(
      ...
      child: FutureBuilder<bool>(
        future: _checkVideoExists(videoUrl),
  ...
  // ======================== SES KAYIT VE OYNATMA METODLARI ========================
  ...
  // ======================== MESAJ SECENEKLERI VE ISLEMLER METODLARI ========================
  ...
  // ======================== EKLENTI VE MEDIA SECIM METODLARI ========================
  ...
  // ======================== IMAGE VE VIDEO SECIM METODLARI ========================
  Future<void> _pickImage(ImageSource source) async {
    try {
      ...
      if (image != null) {
        ...
        _sendFileMessage(file, MessageType.image);
      }
    } catch (e) {
  ...
  Future<void> _pickVideo() async {
    try {
      ...
      if (video != null) {
        ...
        _sendFileMessage(file, MessageType.video);
      }
    } catch (e) {
      if (Navigator.canPop(context)) {
        Navigator.of(context).pop();
                          ...
                          return Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                if (optionControllers.length > 2 && index >= 2)
                                  IconButton(
                                    onPressed: () {
                                      setDialogState(() {
  ...
  Future<void> _launchUrl(String url) async {
    try {
      debugPrint('Açılmaya çalışılan URL: $url');

      // URL'nin başında protokol yoksa ekle
      String formattedUrl = url;
      if (!url.startsWith('http://') && !url.startsWith('https://')) {
        formattedUrl = 'https://$url';
      }

      debugPrint('Formatlanmış URL: $formattedUrl');

      final Uri uri = Uri.parse(formattedUrl);
      debugPrint('Parse edilen URI: $uri');
      ...
      if (await canLaunchUrl(uri)) {
        ...
        if (launched) {
          ...
          debugPrint('URL açılamadı - launchUrl false döndü');
          _showErrorSnackBar('Link açılamadı');
        }
      } else {
        debugPrint('canLaunchUrl false döndü');
        _showErrorSnackBar('Bu link açılamıyor: $url');
      }
    } catch (e) {
      debugPrint('Link açılırken hata oluştu: $e');
      _showErrorSnackBar('Link açılırken hata oluştu: $e');
    }
  }

  // ======================== SNACKBAR VE BILDIRIM METODLARI ========================
